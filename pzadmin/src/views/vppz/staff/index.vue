<template>
        ...
        >
            ...
            <el-form-item label="头像" prop="avatar">
                <el-button
                    v-if="!form.avatar"
                    type="primary"
                    @click="dialogImgFromVisable = true"
                    >点击上传</el-button
                >
                <el-image
                    v-else
    ...
    >
        ...
        <template #footer>
            <div class="dialog-footer">
                <el-button @click="dialogImgFromVisable = false"
                    >取消</el-button
                >
...
// 选择头像弹窗
const dialogImgFromVisable = ref(false);
const fileList = ref([]);
// 选中图片
const selectIndex = ref(0);
const confirmImage = () => {
    form.avatar = fileList.value[selectIndex.value].url;
    dialogImgFromVisable.value = false;
};
